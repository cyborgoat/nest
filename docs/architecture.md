...
Hub sign-in and registration live in **Settings** so browsing local and public content never looks gated. The top-level **Messages** page polls while signed in and shows durable publish-submitted, approved, and rejected notices with unread and deletion controls.
